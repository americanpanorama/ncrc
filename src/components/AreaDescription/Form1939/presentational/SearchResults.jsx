...
const Form1939SearchResults = ({ adData }) => (
  <ul>
    {(adData[1]) && (
      <li>
        ...
        <ul>
          {(adData[1].a) && (
            <li>
              <span className="catLetter catSelectable">
                a
              </span>
              <span className="catName">
                Increasing
          ...
          {(adData[1].c) && (
            <li>
              ...
              <span className="catName catSelectable">
                Foreign Families
              </span>
              <span className="subcatData">
...
export default Form1939SearchResults;

Form1939SearchResults.propTypes = {
